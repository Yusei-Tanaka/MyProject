(() => {
  ...
  const THEME_MAP = {
    ...
    sunset: {
      ...
      "--color-hypothesis-heading": "#8f3a5c",
      "--color-hypothesis-button": "#a6496c",
      "--color-extra-bg": "#fff4eb",
      "--color-extra-border": "#f2d4be",
      "--color-button-primary": "#b44f72",
      "--color-button-primary-hover": "#954060",
      "--color-button-secondary-border": "#d8b9a5",
      "--color-button-secondary-text": "#8a6456",
      "--color-button-secondary-hover": "#fff0e6",
      "--color-edge": "#b08975",
      "--color-node-border": "#b44f72",
      "--color-node-highlight": "#9f4565",
      "--color-node-highlight-text": "#ffffff",
      "--login-page-bg": "linear-gradient(145deg, #fff1ea 0%, #fff9f3 100%)",
      "--login-title-color": "#4a2a22",
      "--login-input-border": "#f2c1b1",
      "--login-input-focus": "#b44f72",
      "--login-button-bg": "#b44f72",
      "--login-button-hover": "#954060",
      "--login-panel-bg": "rgba(255, 255, 255, 0.76)",
      "--login-panel-border": "rgba(180, 79, 114, 0.24)"
    },
    slate: {
