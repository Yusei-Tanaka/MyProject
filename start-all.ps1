# Starts the HTTP server, Flask API, and Node backend API in separate background processes.
...
Write-Host "Started: http.server on 8008, api.py, and JS/server.js (each in its own window)."
